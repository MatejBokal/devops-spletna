    ...
    <div className="px-4 py-12 max-w-screen-md mx-auto space-y-10">
      ...
      <section className="text-center space-y-4">
        ...
        <div className="space-y-2 text-lg">
          <p>
            <span className="font-semibold">Ponedeljek–petek:</span>{' '}
            10.00–23.00
          </p>
          <p>
            <span className="font-semibold">Vikendi & prazniki:</span>{' '}
            12.00–22.00
          </p>
        </div>
        <Link
          href="mailto:strezba.zibert@taprav.si"
      ...
      <section className="bg-white  text-center space-y-2">
        <div className="flex items-center justify-center space-x-2">
          ...
          <a href="mailto:strezba.zibert@taprav.si" className="text-gray-700">
            strezba.zibert@taprav.si
          </a>
        </div>
        <div className="flex items-center justify-center space-x-2">
